...
int main(){
    ...
    //кумулятивно наращиваем количество слов и получаем индексы на которых данный набор кончается со сдвигом 1 вправо
    ...
    //причём после этого число по индексу длинны слов в группе будет ссылаться на индекс конца этой группы. То-есть сдвиг вправо будет нивелирован
